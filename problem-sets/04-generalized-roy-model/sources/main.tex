...
\section*{Task B}
   ...
   %Simulated data has the advantage over empirical data in that we know the underyling distribution of parameters. This way, we can compare our estimated parameters with their actual population counterparts. 
...
\begin{boenumerate}\setcounter{enumi}{3}
  ...
  %Update the distribution of unobservables in
